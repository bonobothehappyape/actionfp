...
@RestController
@RequestMapping("/api/actionfp-kafka")
public class ActionfpKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ActionfpKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ActionfpKafkaResource(KafkaProperties kafkaProperties) {
